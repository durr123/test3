      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Modern Product Suite</h2>
            <p className="text-xl text-gray-600">Our modules are purposefully built for wealth and retirement advisors. We are a one-stop shop for all of your compliance needs.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Email Archiving</h4>
              <p className="text-gray-600 text-center">Archiving solution for all business emails with your clients.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Social Media Archiving</h4>
              <p className="text-gray-600 text-center">Leverage our tools for all your social media compliance needs.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Meeting Archiving</h4>
              <p className="text-gray-600 text-center">Zoom, Teams, Google Meets and VoIP archiving.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Audit Assistance</h4>
              <p className="text-gray-600 text-center">Making audits less stressful and time consuming.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Compliance Automation</h4>
              <p className="text-gray-600 text-center">Automation of key workflows to speed up your compliance function.</p>
            </div>
